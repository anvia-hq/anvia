---
title: "@anvia/milvus: Usage Patterns"
description: "Common ways to compose @anvia/milvus with adjacent Anvia packages."
section: packages
sidebar:
  group: "@anvia/milvus"
  order: 3
...
@anvia/milvus owns persistence and search against Milvus. Application code owns document loading, chunking, embedding, ingestion scheduling, tenant scoping, and when search results are allowed into model context.
