...
export class GrokResponsesCompletionModel implements StreamingCompletionModel {
  ...
  constructor(
    client: OpenAI,
    readonly defaultModel = GROK_4_3,
  ) {
...
export class GrokChatCompletionModel implements StreamingCompletionModel {
