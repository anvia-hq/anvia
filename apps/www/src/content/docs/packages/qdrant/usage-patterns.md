---
title: "@anvia/qdrant: Usage Patterns"
description: "Common ways to compose @anvia/qdrant with adjacent Anvia packages."
section: packages
sidebar:
  group: "@anvia/qdrant"
  order: 3
...
@anvia/qdrant owns persistence and search against Qdrant. Application code owns document loading, chunking, embedding, ingestion scheduling, tenant scoping, and when search results are allowed into model context.
