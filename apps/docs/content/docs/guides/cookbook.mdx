...
| Studio | Single-agent and multi-agent runners, tool approvals, questions, and Knowledge inspection |
...
| Inspect model capabilities | `providers:03` | [Provider Clients and Models](/docs/guides/core-concepts/clients-and-models) |
...
| Inspect locally in Studio | `studio:01`, `studio:05` | [Run Studio](/docs/studio/run-studio) |
