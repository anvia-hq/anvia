...
1. Read [How Anvia Works](/docs/guides/core-concepts/runtime-boundaries) to confirm ownership is clear.
2. Read [Errors and Cancellation](/docs/guides/core-concepts/errors) to plan failure handling.
3. Read [Human in the Loop](/docs/guides/human-in-the-loop) for guarded actions.
4. Read [Messages and History](/docs/guides/core-concepts/messages-and-history) for persistence shape.
