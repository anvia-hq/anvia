...
export function registerStudioUi(app: Hono, options: ResolvedStudioUiOptions): void {
  ...
  app.get(`${options.path}/graphs`, (c) => redirectWithQuery(c, "/graphs"));
  ...
  if (options.rootRoutes) {
    ...
    app.get("/graphs", shellWhenHtml(renderShell));
