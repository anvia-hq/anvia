...
Purpose: factory for Mistral completion and embedding models.

Return behavior: creates or uses a Mistral SDK client, then returns normalized Anvia model adapters.
