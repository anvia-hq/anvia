...
The recipe assumes a compatible API app endpoint. If you do not have one yet, build the app from
[TanStack quickstart](/docs/react-ui/quickstart-tanstack) or wire the endpoint with
