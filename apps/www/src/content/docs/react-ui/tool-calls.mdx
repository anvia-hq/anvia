...
Tool parts come from server-side agent/tool streams. The UI does not execute tools in the browser.
For the route and tool definition, see [Tools end to end](/docs/react-ui/tools-end-to-end).
