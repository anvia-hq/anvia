...
Read [Prompt Requests](/docs/guides/core-concepts/prompt-requests) to see how agents turn prompts, history, context, tools, and runtime options into normalized model requests.
