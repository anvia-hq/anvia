---
title: "@anvia/pgvector: Getting Started"
description: "Install @anvia/pgvector and wire it into an Anvia project."
section: packages
sidebar:
...
Continue with [Usage Patterns](/docs/packages/pgvector/usage-patterns).
