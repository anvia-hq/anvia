---
title: "@anvia/chroma: Usage Patterns"
description: "Common ways to compose @anvia/chroma with adjacent Anvia packages."
section: packages
sidebar:
  group: "@anvia/chroma"
  order: 3
...
@anvia/chroma owns persistence and search against ChromaDB. Application code owns document loading, chunking, embedding, ingestion scheduling, tenant scoping, and when search results are allowed into model context.
