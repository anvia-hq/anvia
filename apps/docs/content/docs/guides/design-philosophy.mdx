...
Anvia is designed as a small runtime library, not a full application platform.

The core idea is simple: AI features should be ordinary TypeScript objects that your application creates, configures, tests, and passes around. Anvia owns the model-facing runtime behavior. Your application owns product behavior.
