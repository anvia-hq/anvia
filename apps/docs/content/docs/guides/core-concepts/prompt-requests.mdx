...
History is not global state inside Anvia. You load it from your application and pass it into the request.
...
2. Add any history from `.withHistory(...)`.
...
Read [Messages and History](/docs/guides/core-concepts/messages-and-history) to understand the `Message[]` shape used by prompts, history, and responses.
