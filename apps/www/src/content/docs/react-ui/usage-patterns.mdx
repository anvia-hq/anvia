...
described in [Server routes](/docs/react-ui/server-routes).
...
See [Composer controls](/docs/react-ui/examples/composer-controls) for a complete recipe.
...
For restored conversations and server history, see [Persistence](/docs/react-ui/persistence).
