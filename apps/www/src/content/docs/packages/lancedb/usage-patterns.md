---
title: "@anvia/lancedb: Usage Patterns"
description: "Common ways to compose @anvia/lancedb with adjacent Anvia packages."
section: packages
sidebar:
  group: "@anvia/lancedb"
  order: 3
...
@anvia/lancedb owns persistence and search against LanceDB. Application code owns document loading, chunking, embedding, ingestion scheduling, tenant scoping, and when search results are allowed into model context.
