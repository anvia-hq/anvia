...
import { z } from "zod";
import { retrieveGraphContext } from "./retrieve.js";
import type {
  CreateNeo4jGraphSearchToolOptions,
  Neo4jGraphSchema,
  Neo4jGraphSearchTool,
...
export function createNeo4jGraphSearchTool<Schema extends Neo4jGraphSchema>(
  options: CreateNeo4jGraphSearchToolOptions<Schema>,
): Neo4jGraphSearchTool {
  return createTool({
    name: options.name,
    ...
    execute: async ({ query }, context) =>
      ...
      } as RetrieveGraphContextOptions<Schema>)) as unknown as z.input<typeof contextSchema>,
  }) as unknown as Neo4jGraphSearchTool;
}
