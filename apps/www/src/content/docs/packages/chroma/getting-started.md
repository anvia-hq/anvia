---
title: "@anvia/chroma: Getting Started"
description: "Install @anvia/chroma and wire it into an Anvia project."
section: packages
sidebar:
  group: "@anvia/chroma"
  order: 2
...
Continue with [Usage Patterns](/docs/packages/chroma/usage-patterns).
