---
title: "@anvia/redis: Usage Patterns"
description: "Common ways to compose @anvia/redis with adjacent Anvia packages."
section: packages
sidebar:
  group: "@anvia/redis"
  order: 3
...
@anvia/redis owns persistence and search against Redis Stack with RediSearch. Application code owns document loading, chunking, embedding, ingestion scheduling, tenant scoping, and when search results are allowed into model context.
