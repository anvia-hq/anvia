---
title: "@anvia/pinecone: Usage Patterns"
description: "Common ways to compose @anvia/pinecone with adjacent Anvia packages."
section: packages
sidebar:
...
@anvia/pinecone owns persistence and search against Pinecone. Application code owns document loading, chunking, embedding, ingestion scheduling, tenant scoping, and when search results are allowed into model context.
